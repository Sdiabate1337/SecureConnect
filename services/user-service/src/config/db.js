...
const MONGO_URL_PATH = '/run/secrets/USER_MONGO_URL'; // Docker secret path
let mongoUrl;
...
try {
  ...
  mongoUrl = process.env.MONGO_URL || 'mongodb://root:password123@mongo:27017/user_service_db?authSource=admin'; // Default fallback
}
